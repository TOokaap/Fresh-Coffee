        ...
        variants: {
            variant: {
                ...
                brouillonOutline:
                    "border bg-background shadow-xs hover:bg-accent hover:text-accent-foreground dark:bg-input/30 dark:border-input dark:hover:bg-input/50",
                published:
                    "bg-green-700 text-green-100 hover:bg-green-100 hover:text-green-700 border border-green-700",
                draft: "bg-amber-700 text-amber-100 hover:bg-amber-100 hover:text-amber-700 border border-amber-700",
                archived:
                    "bg-slate-700 text-slate-100 hover:bg-slate-100 hover:text-slate-700 border border-slate-700",
            },
            size: {
